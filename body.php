				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Official Wear</a></li>
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">ksh 25000 <del class="product-old-price">Ksh 29000</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Kshs 950<del class="product-old-price">Kshs 1500</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Ksh 30000 <del class="product-old-price">Kshs 40000</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
						...
						<div class="products-widget-slick" data-nav="#slick-nav-4">
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">electronics</p>
										<h3 class="product-name"><a href="#">sony a3 tabler</a></h3>
										<h4 class="product-price">Ksh 9500 <del class="product-old-price">Ksh 12000</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">electronic gadgets</p>
										<h3 class="product-name"><a href="#">sony headphones</a></h3>
										<h4 class="product-price">Ksh 900<del class="product-old-price">ksh 1500/del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Ksh 98000 <del class="product-old-price">Ksh 100000</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Electronics</p>
										<h3 class="product-name"><a href="#">Samsung Edge</a></h3>
										<h4 class="product-price">Ksh 25000 <del class="product-old-price">Kshs 30990</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Ksh 40000 <del class="product-old-price">Ksh 50000</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">Ksh 58000 <del class="product-old-price">Ksh 59000</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
