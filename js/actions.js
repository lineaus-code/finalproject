$(document).ready(function(){
	...
	*/
	...
	/*
		match user given string to database keywords column then matched product 
		will show 
	*/
...
// log in
	...
	*/
	...
	net_total();
	/*
		- enable php isset($_POST["Common"]) in action.php page and inside that
		there is two isset funtion which is isset($_POST["getCartItem"]) 
		-isset($_POST["checkOutDetials"])
